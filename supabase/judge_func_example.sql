...
-- Make sure to replace your function URL with the one in Supabase and replace <your-anon-key> with your actual anon key.
...
declare
  ...
  edge_function_url text := 'https://eltsewvhxxqoxjoijrmt.supabase.co/functions/v1/ai-judge'; -- ⚠️ Paste your function URL here
begin
    ...
    if total_participants = submitted_participants then
      ...
      perform net.http_post(
        ...
        headers := jsonb_build_object(
          ...
          'Authorization', 'Bearer ' || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVsdHNld3ZoeHhxb3hqb2lqcm10Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjEzNDI4MTIsImV4cCI6MjA3NjkxODgxMn0.ydfTy63jfJQ4SQWBASI1AoEPfJruPcnFPKBd_rcrc2k' -- ⚠️ Paste your anon key
        )
      );
    end if;
  end if;
